...
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/holo/qotsa.png"
--theme.wallpaper                                 = os.getenv("HOME") .. "/Descargas/inrainbows.jpg"
...
-- spotify
-- needs sp to work (https://gist.github.com/wandernauta/6800547 on /usr/local/bin/)
