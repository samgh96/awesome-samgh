...
globalkeys = awful.util.table.join(
   ...
   -- Backlight
   awful.key({ modkey }, "F11", function () os.execute("xbacklight -dec 10") end),
   awful.key({ modkey }, "F12", function () os.execute("xbacklight -inc 10") end),
   ...
   awful.key({ altkey, }, "h", function () if beautiful.fs then beautiful.fs.show(7) end end),
      ...
      -- Yoga tablet mode
      awful.key({ modkey }, "F10", function() os.execute("yoga mode tablet") end),
      awful.key({ modkey }, "F9", function() os.execute("yoga mode laptop") end),
      -- User programs
...
local net_wireless = net_widgets.wireless({interface="wlp2s0"})
